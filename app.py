...
data = pd.read_csv("D:\Projects\CloudBurst\datasets/train_test_data.csv")
# data.head()

df = data.drop(columns='SUBDIVISION')
df=df.fillna(df.mean())

group = data.groupby('SUBDIVISION')[['YEAR','JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC']]
data=group.get_group(('HIMACHAL PRADESH'))
# data.head()
...
file = open("D:\Projects\CloudBurst\datasets\model.pkl","wb")
